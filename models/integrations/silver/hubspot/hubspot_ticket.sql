...
SELECT
    TRY_TO_NUMBER(TRIM(PROPERTY_HS_TICKET_ID)) AS TICKET_ID,
    ...
    TRY_TO_NUMBER(TRIM(PROPERTY_HS_PIPELINE)) AS PIPELINE_ID,
    TRY_TO_NUMBER(TRIM(PROPERTY_HS_PIPELINE_STAGE)) AS PIPELINE_STAGE_ID,
