...
(
    select
        ...
        CAST(TRIM(RETURNED_AT) AS BIGINT) AS RETURNED_AT,
        CAST(TRIM(RETURN_TRANSACTION_ID) AS BIGINT) AS RETURN_TRANSACTION_ID,
        CAST(TRIM(CATEGORY_ID) AS BIGINT) AS CATEGORY_ID,
        CAST(TRIM(ITEM_BASE_ID) AS BIGINT) AS ITEM_BASE_ID,
        CAST(TRIM(TYPE_ID) AS BIGINT) AS TYPE_ID,
        CAST(TRIM(ACCOUNT_CODE_ID) AS INT) AS ACCOUNT_CODE_ID,
        CAST(TRIM(TIMESTAMP) AS BIGINT) AS TIMESTAMP,
        TRIM(WHY) AS WHY,
