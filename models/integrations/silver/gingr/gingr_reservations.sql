...
(
    select
        ...
        CAST(CANCEL_STAMP AS BIGINT) AS CANCEL_STAMP,
        CAST(CONFIRMED_STAMP AS BIGINT) AS CONFIRMED_STAMP,
        CAST(WAIT_LIST_STAMP AS BIGINT) AS WAIT_LIST_STAMP,
        CAST(WAIT_LIST_ACCEPTED_STAMP AS BIGINT) AS WAIT_LIST_ACCEPTED_STAMP,
        CAST(CHECK_IN_STAMP AS BIGINT) AS CHECK_IN_STAMP,
        CAST(CHECK_OUT_STAMP AS BIGINT) AS CHECK_OUT_STAMP,
